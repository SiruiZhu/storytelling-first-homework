...
(function () {
  ...
  var svg = d3.select('#chart2').attr('width', 400).attr('height', 200);

  var widthScale = d3.scaleLinear().domain([0, 100]).range([0, 400]);

  var colorScale = d3.scaleOrdinal().range(['#f1eef6', '#d7b5d8', '#df65b0', '#ce1256']);
...
//# sourceMappingURL=/02-chart.5453814c.map